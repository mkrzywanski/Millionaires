...
function $c_Lexample_ScalaJSExample$() {
  ...
  this.winningValueSeq$1 = null;
  this.chars$1 = null;
  this.host$1 = null;
  this.currentQuestion$1 = null
}
...
$c_Lexample_ScalaJSExample$.prototype.proceedFiftyFiftyHint__V = (function() {
  var url = ((this.host$1 + "/questions/eliminate/") + this.currentQuestion$1.id);
  ...
  var pf = new $c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1().init___();
...
$c_Lexample_ScalaJSExample$.prototype.init___ = (function() {
  ...
  this.winningValueSeq$1 = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([500, 1000, 2000, 5000, 10000, 20000, 40000, 75000, 125000, 250000, 500000, 1000000])));
  this.chars$1 = $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["A", "B", "C", "D"])));
  this.host$1 = "http://localhost:9000";
  return this
});
$c_Lexample_ScalaJSExample$.prototype.answerOneClicked__V = (function() {
  var id = $objectToString(this.currentQuestion$1.answers[0].id);
  this.checkAnswer__T__V(id)
});
$c_Lexample_ScalaJSExample$.prototype.checkAnswer__T__V = (function(id) {
  var url = ((this.host$1 + "/answers/correct/") + id);
  var this$3 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var headers = $m_sci_Map$EmptyMap$();
  var this$4 = this$3.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("GET", url, null, 0, headers, false, "");
  var pf = new $c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1().init___();
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  $s_s_concurrent_Future$class__onSuccess__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__V(this$4, pf, executor)
});
$c_Lexample_ScalaJSExample$.prototype.updateLevelUI__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("currentLevelWinnings").innerHTML = (("Pytanie za " + this.winningValueSeq$1.apply__I__O((((-1) + this.currentLevel$1) | 0))) + "z\u0142")
});
$c_Lexample_ScalaJSExample$.prototype.answerFourClicked__V = (function() {
  var id = $objectToString(this.currentQuestion$1.answers[3].id);
  this.checkAnswer__T__V(id)
});
$c_Lexample_ScalaJSExample$.prototype.updateQuestionUI__V = (function() {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("question").innerHTML = $objectToString(this.currentQuestion$1.content);
  var i = 0;
  while (true) {
    var v1 = i;
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(("answer" + ((1 + v1) | 0))).textContent = (($as_T($m_Lexample_ScalaJSExample$().chars$1.apply__I__O(v1)) + " : ") + $objectToString($m_Lexample_ScalaJSExample$().currentQuestion$1.answers[v1].content));
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(("answer" + ((1 + v1) | 0))).removeAttribute("disabled");
    if ((i === 3)) {
      break
    };
    i = ((1 + i) | 0)
...
$c_Lexample_ScalaJSExample$.prototype.findAnswerIndex__T__I = (function(answerId) {
  var elem$1 = 0;
  elem$1 = 0;
  var i = 0;
  while (true) {
    var v1 = i;
    if (($objectToString($m_Lexample_ScalaJSExample$().currentQuestion$1.answers[v1].id) === answerId)) {
      elem$1 = v1
    };
    if ((i === 3)) {
      break
...
$c_Lexample_ScalaJSExample$.prototype.createAnswerOneDiv__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-6", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-primary", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answer1", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answerOneClicked()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Answer1"))]))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lexample_ScalaJSExample$.prototype.main__V = (function() {
  var jsx$10 = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("pageContent");
  ...
  var e = this.createCurrentQuestionValueDiv__Lorg_scalajs_dom_raw_HTMLDivElement();
  var jsx$8 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$1, e);
  var this$2 = $m_Lscalatags_JsDom$all$();
  var e$1 = this.createQuestionDiv__Lorg_scalajs_dom_raw_HTMLDivElement();
  var jsx$7 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$2, e$1);
  var this$3 = $m_Lscalatags_JsDom$all$();
  var e$2 = this.createAnswerOneDiv__Lorg_scalajs_dom_raw_HTMLDivElement();
  var jsx$6 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$3, e$2);
  var this$4 = $m_Lscalatags_JsDom$all$();
  var e$3 = this.createAnswerTwoDiv__Lorg_scalajs_dom_raw_HTMLDivElement();
  var jsx$5 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$4, e$3);
  var this$5 = $m_Lscalatags_JsDom$all$();
  var e$4 = this.createAnswerThreeDiv__Lorg_scalajs_dom_raw_HTMLDivElement();
  var jsx$4 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$5, e$4);
  var this$6 = $m_Lscalatags_JsDom$all$();
  var e$5 = this.createAnswerFourDiv__Lorg_scalajs_dom_raw_HTMLDivElement();
  var jsx$3 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$6, e$5);
  var this$7 = $m_Lscalatags_JsDom$all$();
  var e$6 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().br__Lscalatags_generic_TypedTag()).render__Lorg_scalajs_dom_raw_Element();
  var jsx$2 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$7, e$6);
  var this$8 = $m_Lscalatags_JsDom$all$();
  var e$7 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().br__Lscalatags_generic_TypedTag()).render__Lorg_scalajs_dom_raw_Element();
  var jsx$1 = new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$8, e$7);
  var this$9 = $m_Lscalatags_JsDom$all$();
  var e$8 = this.createHintsRow__Lorg_scalajs_dom_raw_HTMLDivElement();
  jsx$10.appendChild(jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$8, jsx$7, jsx$6, jsx$5, jsx$4, jsx$3, jsx$2, jsx$1, new $c_Lscalatags_LowPriorityImplicits$bindNode().init___Lscalatags_LowPriorityImplicits__Lorg_scalajs_dom_raw_Node(this$9, e$8)])).render__Lorg_scalajs_dom_raw_Element());
  this.donwloadNewQuestion__V()
});
$c_Lexample_ScalaJSExample$.prototype.donwloadNewQuestion__V = (function() {
  var url = ((this.host$1 + "/questions/random/") + this.currentLevel$1);
  var this$3 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var headers = $m_sci_Map$EmptyMap$();
  var this$4 = this$3.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("GET", url, null, 0, headers, false, "");
  var pf = new $c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1().init___();
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  $s_s_concurrent_Future$class__onSuccess__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__V(this$4, pf, executor)
});
$c_Lexample_ScalaJSExample$.prototype.answerThreeClicked__V = (function() {
  var id = $objectToString(this.currentQuestion$1.answers[2].id);
  this.checkAnswer__T__V(id)
});
$c_Lexample_ScalaJSExample$.prototype.proceedQuestionToAudienceHint__V = (function() {
  var url = ((this.host$1 + "/questions/audience/") + this.currentQuestion$1.id);
  var this$3 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var headers = $m_sci_Map$EmptyMap$();
  var this$4 = this$3.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("GET", url, null, 0, headers, false, "");
  var pf = new $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1().init___();
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  $s_s_concurrent_Future$class__onSuccess__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__V(this$4, pf, executor)
});
$c_Lexample_ScalaJSExample$.prototype.proceedQuestionToAFriend__V = (function() {
  var url = ((this.host$1 + "/questions/toFriend/") + this.currentQuestion$1.id);
  var this$3 = $m_Lorg_scalajs_dom_ext_Ajax$();
  var headers = $m_sci_Map$EmptyMap$();
  var this$4 = this$3.apply__T__T__Lorg_scalajs_dom_ext_Ajax$InputData__I__sci_Map__Z__T__s_concurrent_Future("GET", url, null, 0, headers, false, "");
  var pf = new $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1().init___();
  var executor = $m_s_concurrent_ExecutionContext$Implicits$().global__s_concurrent_ExecutionContextExecutor();
  $s_s_concurrent_Future$class__onSuccess__s_concurrent_Future__s_PartialFunction__s_concurrent_ExecutionContext__V(this$4, pf, executor)
});
$c_Lexample_ScalaJSExample$.prototype.createAnswerTwoDiv__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-6", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-primary", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answer2", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answerTwoClicked()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Answer2"))]))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lexample_ScalaJSExample$.prototype.createCurrentQuestionValueDiv__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  var jsx$6 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag());
  var jsx$5 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-12", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$4 = $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("questionValue", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$3 = $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag());
  var jsx$2 = $m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text-center", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var jsx$1 = $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("currentLevelWinnings", $m_Lscalatags_JsDom$all$().stringAttr$1);
  $m_Lscalatags_JsDom$all$();
  var v = (("Pytanie za " + this.winningValueSeq$1.apply__I__O((((-1) + this.currentLevel$1) | 0))) + " z\u0142");
  return jsx$6.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$5, jsx$4, jsx$3.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([jsx$2, jsx$1, new $c_Lscalatags_JsDom$StringFrag().init___T(v)]))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lexample_ScalaJSExample$.prototype.createHintsRow__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-12", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text-center", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Ko\u0142a Ratunkowe"))]))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-info", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("hintFiftyFifty", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("fiftyFiftyHint()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("50 : 50"))]))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-info", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("hintAudience", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("questionToAudience()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Zapytaj publiczno\u015bci"))]))])), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-4", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-info", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("hintFriend", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("questionToFriend()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Ask a friend"))]))]))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lexample_ScalaJSExample$.prototype.answerTwoClicked__V = (function() {
  var id = $objectToString(this.currentQuestion$1.answers[1].id);
  this.checkAnswer__T__V(id)
});
$c_Lexample_ScalaJSExample$.prototype.$$js$exported$meth$main__O = (function() {
  this.main__V()
});
$c_Lexample_ScalaJSExample$.prototype.createAnswerFourDiv__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-6", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-primary", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answer4", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answerFourClicked()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Answer4"))]))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lexample_ScalaJSExample$.prototype.createAnswerThreeDiv__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-6", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().button__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("btn-block btn btn-primary", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answer3", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().onclick__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("answerThreeClicked()", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Answer3"))]))])).render__Lorg_scalajs_dom_raw_Element()
});
$c_Lexample_ScalaJSExample$.prototype.disableAnswerButton__I__V = (function(buttonIndex) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(("answer" + ((1 + buttonIndex) | 0))).setAttribute("disabled", "true");
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById(("answer" + ((1 + buttonIndex) | 0))).textContent = "-----------"
});
$c_Lexample_ScalaJSExample$.prototype.createQuestionDiv__Lorg_scalajs_dom_raw_HTMLDivElement = (function() {
  return $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().div__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("col-md-12", $m_Lscalatags_JsDom$all$().stringAttr$1), $as_Lscalatags_JsDom$TypedTag($m_Lscalatags_JsDom$all$().p__Lscalatags_generic_TypedTag()).apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_Lscalatags_JsDom$all$().$class__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("text-center", $m_Lscalatags_JsDom$all$().stringAttr$1), $m_Lscalatags_JsDom$all$().id__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("question", $m_Lscalatags_JsDom$all$().stringAttr$1), ($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Question"))]))])).render__Lorg_scalajs_dom_raw_Element()
});
...
/** @constructor */
function $c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.constructor = $c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1;
/** @constructor */
function $h_Lexample_ScalaJSExample$$anonfun$checkAnswer$1() {
  /*<skip>*/
}
$h_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype = $c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype;
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.init___ = (function() {
  return this
});
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O = (function(x1, $default) {
  if (($uI(x1.status) === 200)) {
    var json = $g.JSON.parse($as_T(x1.responseText));
    if ($m_sr_BoxesRunTime$().equals__O__O__Z(json.isCorrect, true)) {
      $g.alert("Odpowied\u017a poprawna");
      if (($m_Lexample_ScalaJSExample$().currentLevel$1 < 12)) {
        $m_Lexample_ScalaJSExample$().currentLevel$1 = ((1 + $m_Lexample_ScalaJSExample$().currentLevel$1) | 0);
        $m_Lexample_ScalaJSExample$().donwloadNewQuestion__V();
        $m_Lexample_ScalaJSExample$().updateLevelUI__V();
        return (void 0)
      } else {
        $g.alert("Wygra\u0142e\u015b milion! Restart gry.");
        var qual$1 = $m_Lorg_scalajs_dom_package$().window__Lorg_scalajs_dom_raw_Window().location;
        qual$1.reload();
        return (void 0)
      }
    } else {
...
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z = (function(x1) {
  return true
});
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z(x)
});
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O(x, $default)
});
var $d_Lexample_ScalaJSExample$$anonfun$checkAnswer$1 = new $TypeData().initClass({
  Lexample_ScalaJSExample$$anonfun$checkAnswer$1: 0
}, false, "example.ScalaJSExample$$anonfun$checkAnswer$1", {
  Lexample_ScalaJSExample$$anonfun$checkAnswer$1: 1,
...
$c_Lexample_ScalaJSExample$$anonfun$checkAnswer$1.prototype.$classData = $d_Lexample_ScalaJSExample$$anonfun$checkAnswer$1;
/** @constructor */
function $c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.constructor = $c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1;
/** @constructor */
function $h_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1() {
  /*<skip>*/
}
$h_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype = $c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype;
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.init___ = (function() {
  return this
});
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O = (function(x2, $default) {
  if (($uI(x2.status) === 200)) {
    var json = $g.JSON.parse($as_T(x2.responseText));
    $m_Lexample_ScalaJSExample$().currentQuestion$1 = json;
    $m_Lexample_ScalaJSExample$().updateQuestionUI__V();
    return (void 0)
  } else {
    return (void 0)
  }
});
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z = (function(x2) {
  return true
});
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z(x)
});
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O(x, $default)
});
var $d_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1 = new $TypeData().initClass({
  Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1: 0
}, false, "example.ScalaJSExample$$anonfun$donwloadNewQuestion$1", {
  Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1.prototype.$classData = $d_Lexample_ScalaJSExample$$anonfun$donwloadNewQuestion$1;
/** @constructor */
function $c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.constructor = $c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1;
/** @constructor */
function $h_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1() {
  /*<skip>*/
}
$h_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype = $c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype;
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.init___ = (function() {
  return this
});
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O = (function(x5, $default) {
  if (($uI(x5.status) === 200)) {
    var json = $g.JSON.parse($as_T(x5.responseText));
    var firstAnswerIndex = $m_Lexample_ScalaJSExample$().findAnswerIndex__T__I($objectToString(json[0].id));
    $m_Lexample_ScalaJSExample$().disableAnswerButton__I__V(firstAnswerIndex);
    var secondAnswerIndex = $m_Lexample_ScalaJSExample$().findAnswerIndex__T__I($objectToString(json[1].id));
    $m_Lexample_ScalaJSExample$().disableAnswerButton__I__V(secondAnswerIndex);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("hintFiftyFifty").setAttribute("disabled", "true");
    return (void 0)
  } else {
    return (void 0)
  }
});
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z = (function(x5) {
  return true
});
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z(x)
});
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O(x, $default)
});
var $d_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1 = new $TypeData().initClass({
  Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1: 0
}, false, "example.ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1", {
  Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1.prototype.$classData = $d_Lexample_ScalaJSExample$$anonfun$proceedFiftyFiftyHint$1;
/** @constructor */
function $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.constructor = $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1;
/** @constructor */
function $h_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1() {
  /*<skip>*/
}
$h_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype = $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype;
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.init___ = (function() {
  return this
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O = (function(x4, $default) {
  if (($uI(x4.status) === 200)) {
    var json = $g.JSON.parse($as_T(x4.responseText));
    var correctAnswerIndex = $m_Lexample_ScalaJSExample$().findAnswerIndex__T__I($objectToString(json.answerId));
    var jsx$1 = $m_s_Predef$any2stringadd$();
    var self = json.content;
    var s = (("" + jsx$1.$$plus$extension__O__T__T(self, " ")) + $m_Lexample_ScalaJSExample$().chars$1.apply__I__O(correctAnswerIndex));
    $g.alert(s);
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("hintFriend").setAttribute("disabled", "true");
    return (void 0)
  } else {
    return (void 0)
  }
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z = (function(x4) {
  return true
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z(x)
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O(x, $default)
});
var $d_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1 = new $TypeData().initClass({
  Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1: 0
}, false, "example.ScalaJSExample$$anonfun$proceedQuestionToAFriend$1", {
  Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1.prototype.$classData = $d_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAFriend$1;
/** @constructor */
function $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.constructor = $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1;
/** @constructor */
function $h_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1() {
  /*<skip>*/
}
$h_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype = $c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype;
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.init___ = (function() {
  return this
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O = (function(x3, $default) {
  if (($uI(x3.status) === 200)) {
    var json = $g.JSON.parse($as_T(x3.responseText));
    var elem$1 = null;
    elem$1 = "Wyniki publiczno\u015bci :\n";
    var i = 0;
    while (true) {
      var v1 = i;
      elem$1 = (($as_T(elem$1) + (($as_T($m_Lexample_ScalaJSExample$().chars$1.apply__I__O(v1)) + " : ") + json[v1].percentage)) + " %\n");
      if ((i === 3)) {
        break
      };
      i = ((1 + i) | 0)
    };
    $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("hintAudience").setAttribute("disabled", "true");
    var s = $as_T(elem$1);
    return $g.alert(s)
  } else {
    return (void 0)
...
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z = (function(x3) {
  return true
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__Lorg_scalajs_dom_raw_XMLHttpRequest__Z(x)
});
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__Lorg_scalajs_dom_raw_XMLHttpRequest__F1__O(x, $default)
});
var $d_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1 = new $TypeData().initClass({
  Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1: 0
}, false, "example.ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1", {
  Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1.prototype.$classData = $d_Lexample_ScalaJSExample$$anonfun$proceedQuestionToAudienceHint$1;
/** @constructor */
...
$e.fiftyFiftyHint = (function() {
  $m_Lexample_ScalaJSExample$().proceedFiftyFiftyHint__V()
});
$e.questionToAudience = (function() {
  $m_Lexample_ScalaJSExample$().proceedQuestionToAudienceHint__V()
});
$e.answerThreeClicked = (function() {
  $m_Lexample_ScalaJSExample$().answerThreeClicked__V()
});
$e.questionToFriend = (function() {
  $m_Lexample_ScalaJSExample$().proceedQuestionToAFriend__V()
});
$e.answerTwoClicked = (function() {
  $m_Lexample_ScalaJSExample$().answerTwoClicked__V()
});
$e.answerOneClicked = (function() {
  $m_Lexample_ScalaJSExample$().answerOneClicked__V()
});
$e.answerFourClicked = (function() {
  $m_Lexample_ScalaJSExample$().answerFourClicked__V()
});
